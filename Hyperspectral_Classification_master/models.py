...
from Hyperspectral_Classification_master.utils import grouper, sliding_window, count_sliding_window, camel_to_snake
...
def get_model(name, **kwargs):
    ...
    if name == 'nn':
        ...
        center_pixel = True 
        patch_size = kwargs.setdefault('patch_size', 3)  # 9
    ...
    kwargs.setdefault('batch_size', 50) # 128
...
class LiuEtAl(nn.Module):
    ...
    def __init__(self, input_channels, n_classes, patch_size=9):
        ...
        self.conv1 = nn.Conv2d(input_channels, 80, (1, 1), stride=(1, 1), padding=(1,1))
